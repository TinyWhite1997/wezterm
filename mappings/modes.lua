...
local key_tables = {
  ...
  copy_mode = {
    ...
    {
      "O",
      act.CopyMode "MoveToSelectionOtherEndHoriz",
      "selection other end",
    },
  ...
  resize_mode = {
    { "<ESC>", "PopKeyTable", "exit" },
    { "h", act.AdjustPaneSize { "Left", 2 }, "resize left" },
    { "j", act.AdjustPaneSize { "Down", 2 }, "resize down" },
    { "k", act.AdjustPaneSize { "Up", 2 }, "resize up" },
    { "l", act.AdjustPaneSize { "Right", 2 }, "resize right" },
    { "<LeftArrow>", act.AdjustPaneSize { "Left", 2 }, "" },
    { "<DownArrow>", act.AdjustPaneSize { "Down", 2 }, "" },
    { "<UpArrow>", act.AdjustPaneSize { "Up", 2 }, "" },
    { "<RightArrow>", act.AdjustPaneSize { "Right", 2 }, "" },
  },
