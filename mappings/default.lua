...
local mappings = {
  { "<S-M-]>", act.ActivateTabRelative(1), "next tab" },
  { "<S-M-[>", act.ActivateTabRelative(-1), "prev tab" },
  { "<M-CR>", act.ToggleFullScreen, "fullscreen" },
  { "<M-c>", act.CopyTo "Clipboard", "copy" },
  { "<M-v>", act.PasteFrom "Clipboard", "paste" },
  ...
  { "<M-S-_>", act.SplitVertical { domain = "CurrentPaneDomain" }, "hsplit" },
  {
    "<M-]>",
